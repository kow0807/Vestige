...
public:
	...
	// 初期座標
	static constexpr VECTOR INIT_POS = { 0.0f, -100.0f, 0.0f };			// 初期座標
	...
	// 音関連
	static constexpr int SOUND_VALUE = 180;									// 音量

	// アニメーション関連
	static constexpr float IDLE_ANIM_SPEED = 20.0f;							// 待機アニメーション速度
	static constexpr float WALK_ANIM_SPEED = 30.0f;							// 歩きアニメーション速度
	static constexpr float LOOK_ANIM_SPEED = 34.0f;							// 見るアニメーション速度
	static constexpr float STANDBY_ANIM_SPEED = 20.0f;						// 待機アニメーション速度
	static constexpr float ANIM_BLEND_RATE = 5.0f;							// アニメーションのブレンド率

	// 移動速度
	static constexpr float MOVE_SPEED = 1.8f;								// 移動速度
